...
- [算法](./doc/算法.md)
    ...
    - [查找类算法] 
        - [顺序查找](./doc/顺序查找.md)   [二分查找](./doc/二分查找.md)   [哈希算法](./doc/哈希算法.md)   [插值查找]   [斐波那契查找](./doc/查找类算法.md)   [树表查找]   [分块查找]
    - [排序类算法]  
        - [冒泡排序](./doc/冒泡排序.md)   [快速排序](./doc/快速排序.md)   [选择排序](./doc/选择排序.md)  [插入法排序](./doc/插入法排序.md)  [计数排序](./doc/计数排序.md)  [堆排序](./doc/堆排序.md)  [归并排序](./doc/归并排序.md)   [桶排序](./doc/桶排序.md) [无](./doc/排序类算法.md)
    - [搜索类算法]
- [设计模式]
    - [创建型] 
