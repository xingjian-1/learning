#### 为什么要了解多线程
* 了解并发编程必要性：实际工作中可能比较少写多线程的代码，一般都是被别人封装起来我们拿来直接用，虽然编码中很少会自己去创建线程，但是实际开发中每行代码却都是并行执行的，同一时刻大量请求同一个接口，并发可能会产生一些问题，所以掌握一定的并发知识也是必要的。并发编程：多个任务可以同时做，常用于任务之间比较独立，互不影响，线程上下文切换：
...
* 多线程可以提高程序的效率。
		...
		村长要求喜洋洋在一个小时内打100桶水，可是喜洋洋一个小时只能打25桶水，如果这样的话就需要4个小时才能完成任务，为了在一个小时能够完成任务，喜洋洋就请美洋洋、懒洋洋、沸洋洋，来帮忙，这样4只羊同时干活，在一小时内完成了任务。原本用4个小时完成的任务现在只需要1个小时就完成了，如果把每只羊看做一个线程，多只羊即多线程可以提高程序的效率。
#### 线程和进程
